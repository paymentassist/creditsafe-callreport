...
class CTInputaddressandmatchesFullmatches
{
    /**
     * Contains address details as found on the database as well as a series of name matching info
     *
     * @var array<int<0,max>, \PaymentAssist\Type\CTInputaddressandmatchesFullmatch>
     */
    ...
    /**
     * @return array<int<0,max>, \PaymentAssist\Type\CTInputaddressandmatchesFullmatch>
     */
    ...
    /**
     * @param array<int<0,max>, \PaymentAssist\Type\CTInputaddressandmatchesFullmatch> $fullmatch
     * @return static
     */
