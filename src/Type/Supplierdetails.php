...
use \PaymentAssist\Type\CTSupplierdetails;

class Supplierdetails extends CTSupplierdetails
{
    /**
     * Supplier name
     *
    ...
    /**
     * A value of 1 indicates that the data supplier has supplied Behavoural Data.
     *
     * @var null | int
     */
    private ?int $apacs = null;
     ...
     * @return null | int
     */
    public function getApacs() : ?int
    {
        return $this->apacs;
    }

    /**
     * @param null | int $apacs
     * @return static
     */
    public function withApacs(?int $apacs) : static
    {
        $new = clone $this;
        $new->apacs = $apacs;
